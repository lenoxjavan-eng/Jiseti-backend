...
from .views import AdminRecordStatusView, MyRecordListView, RecordDetailView, RecordListCreateView, RecordLocationView
...
urlpatterns = [
	...
	path('records/<int:pk>/location/', RecordLocationView.as_view(), name='record-location'),
